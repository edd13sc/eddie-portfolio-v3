...
const ProjectCardSkeleton = () => (_jsxs("div", { className: "overflow-hidden w-full min-w-[250px] max-w-[600px] border border-gray-800 flex flex-col gap-6 h-fit", children: [_jsx(Skeleton.Image, { style: { width: '100%', height: '200px' }, active: true }), _jsx("div", { className: "p-6 mt-[-120px]", children: _jsxs("div", { className: "flex flex-col gap-6 w-full p-4 bg-[#010101] border border-gray-800", children: [_jsxs("div", { className: "flex flex-col gap-3", children: [_jsx(Skeleton.Input, { style: { width: '60%', height: '24px' }, active: true }), _jsx(Skeleton, { paragraph: { rows: 3, width: ['100%', '100%', '80%'] }, title: false, active: true }), _jsxs("div", { className: "flex items-center gap-2 mt-2", children: [_jsx(Skeleton.Avatar, { size: "small", shape: "square", active: true }), _jsx(Skeleton.Input, { style: { width: '80px', height: '16px' }, active: true })] })] }), _jsxs("div", { className: "flex w-full gap-4 justify-between items-center", children: [_jsx(Skeleton.Button, { style: { width: '120px' }, active: true }), _jsx(Skeleton.Avatar, { size: "small", active: true })] })] }) })] }));
