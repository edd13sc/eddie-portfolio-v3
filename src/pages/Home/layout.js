...
const DynamicGrid = () => {
    ...
    return (_jsxs("div", { className: 'w-full h-dvh overflow-hidden flex justify-center items-center', children: [_jsxs("video", { autoPlay: true, muted: true, loop: true, className: `'w-vw absolute scale-y-130 z-10 select-none h-full pointer-events-none 
                            ${hoveredCell === 3 ? 'opacity-60' : 'opacity-0'} t-0 l-0 r-0 b-0'`, style: {
                    mixBlendMode: 'screen',
                    width: '105vw',
                    height: '100vh'
                }, children: [_jsx("source", { src: "https://storage.cloud.google.com/engineered-imagination/grunge_textures.mp4", type: "video/mp4" }), "Your browser does not support the video tag."] }), _jsxs("div", { className: "w-full h-dvh grid transition-all duration-300 linear", style: {
                    ...gridStyle,
                    gridTemplateAreas: `
                    "cell1 cell2 cell2"
                    "cell1 cell3 cell4"
                    "cell5 cell5 cell4"
                    `
                }, children: [_jsxs(Link, { to: 'projects', className: "bg-gray-800 border-2 border-gray-200 transition-all duration-500 ease-out cursor-pointer flex items-center justify-center overflow-hidden", style: {
                            gridArea: 'cell1',
                        ...
                        }, onMouseEnter: () => handleMouseEnter(1), onMouseLeave: handleMouseLeave, children: [_jsx("span", { className: `font-medium text-white transition-all duration-500 uppercase ${hoveredCell !== 1 ? 'opacity-100' : 'opacity-0'}`, style: {
                        ...
                        }, onMouseEnter: () => handleMouseEnter(2), onMouseLeave: handleMouseLeave, children: [_jsx("span", { className: "font-medium text-white transition-all duration-500 uppercase", style: {
                                    fontSize: hoveredCell === 2 ? '3rem' : '36rem',
                                    transform: hoveredCell === 2 ? 'scale(1.1)' : 'scale(1)',
                                    fontFamily: 'Space Grotesk'
                                }, children: "About" }), _jsxs("video", { autoPlay: true, muted: true, loop: true, className: `max-w-[1200px] min-w-[1500px] scale-[0.8] absolute z-10 select-none pointer-events-none
                            ${hoveredCell === 2 ? 'opacity-100' : 'opacity-0'}`, style: {
                                    mixBlendMode: 'screen',
                                    transform: 'rotate(90deg)'
                                }, children: [_jsx("source", { src: "https://storage.googleapis.com/engineered-imagination/video_overlays.mp4", type: "video/mp4" }), "Your browser does not support the video tag."] })] }), _jsx(Link, { to: 'about', className: "bg-gray-800 border-2 border-gray-200 transition-all duration-500 ease-out cursor-pointer flex items-center justify-center overflow-hidden", style: {
                            gridArea: 'cell3',
                        ...
                        }, onMouseEnter: () => handleMouseEnter(3), onMouseLeave: handleMouseLeave, children: _jsxs("span", { className: "font-medium text-white transition-all duration-800 uppercase flex justify-center items-center\r\n                    w-full h-full\r\n                    ", style: {
                        ...
                        }, onMouseEnter: () => handleMouseEnter(4), onMouseLeave: handleMouseLeave, children: [_jsx("span", { className: "font-medium transition-all duration-500 uppercase absolute z-20", style: {
                                    fontSize: hoveredCell === 4 ? '4rem' : '3rem',
                                    transform: hoveredCell === 4 ? 'scale(1.1)' : 'scale(1)',
                                    fontFamily: 'Space Grotesk',
                                    color: hoveredCell === 4 ? 'black' : 'white'
                                }, children: "Services" }), _jsxs("video", { autoPlay: true, muted: true, loop: true, className: `max-w-[1200px] min-w-[800px] absolute z-10 select-none pointer-events-none invert-[1]
                                    ${hoveredCell === 4 ? 'opacity-100' : 'opacity-0'}`, style: {
                                    mixBlendMode: 'screen',
                                    transform: 'rotate(90deg)'
                                }, children: [_jsx("source", { src: "https://storage.googleapis.com/engineered-imagination/video_overlays.mp4", type: "video/mp4" }), "Your browser does not support the video tag."] })] }), _jsxs(Link, { to: 'contact', className: "bg-gray-800 border-2 border-gray-200 transition-all duration-500 ease-out cursor-pointer flex items-center justify-center overflow-hidden", style: {
                            gridArea: 'cell5',
                        ...
                        }, onMouseEnter: () => handleMouseEnter(5), onMouseLeave: handleMouseLeave, children: [_jsx("span", { className: "font-base text-white transition-all duration-500 uppercase flex items-center", style: {
                                    fontSize: hoveredCell === 5 ? '6rem' : '34rem',
                                    transform: hoveredCell === 5 ? 'scale(1.1)' : 'scale(1)',
                                    fontFamily: 'Space Grotesk'
                                }, children: "Contact" }), _jsxs("video", { autoPlay: true, muted: true, loop: true, className: `max-w-[1200px] min-w-[1500px] scale-[0.8] absolute z-10 select-none pointer-events-none
                                    ${hoveredCell === 5 ? 'opacity-100' : 'opacity-0'}`, style: {
                                    mixBlendMode: 'screen',
                                    // transform: 'rotate(90deg)'
                                }, children: [_jsx("source", { src: "https://storage.googleapis.com/engineered-imagination/video_overlays.mp4", type: "video/mp4" }), "Your browser does not support the video tag."] })] })] })] }));
};
