...
const WaterLensCursor = ({ children, intensity = 1, size = 240, fadeSpeed = 0.05 }) => {
    ...
    const generateWaterDistortion = (rect) => {
        if (effectIntensity === 0)
            return {};
        const distance = Math.sqrt((mousePos.x - rect.left - rect.width / 2) ** 2 +
    ...
    return (_jsxs("div", { ref: containerRef, className: "relative", style: { cursor: 'none' }, children: [_jsx("div", { className: "relative z-10", children: React.Children.map(children, (child, index) => {
                    ...
                    return child;
                }) }), effectIntensity > 0 && (_jsxs("div", { className: "absolute z-20 pointer-events-none", style: {
